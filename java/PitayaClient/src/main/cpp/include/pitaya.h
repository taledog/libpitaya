...
#define PC_CLIENT_CONFIG_DEFAULT_CONN_TIMEOUT 30
#define PC_CLIENT_CONFIG_DEFAULT_ENABLE_RECONN 1
#define PC_CLIENT_CONFIG_DEFAULT_RECONN_MAX_RETRY PC_ALWAYS_RETRY
#define PC_CLIENT_CONFIG_DEFAULT_RECONN_DELAY 2
#define PC_CLIENT_CONFIG_DEFAULT_RECONN_DELAY_MAX 30
#define PC_CLIENT_CONFIG_DEFAULT_RECONN_EXP_BACKOFF 1
#define PC_CLIENT_CONFIG_DEFAULT_ENABLE_POLLING 0
#define PC_CLIENT_CONFIG_DEFAULT_TRANSPORT_NAME PC_TR_NAME_UV_TCP
#define PC_CLIENT_CONFIG_DEFAULT_DISABLE_COMPRESSION 0
